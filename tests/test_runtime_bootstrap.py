...
class RuntimeBootstrapperSeedTests(unittest.TestCase):
    ...
    def test_ensure_model_directory_logs_first_start_download_hint_when_missing(self) -> None:
        ...
        bootstrapper._ensure_model_directory()
        self.assertTrue(
            any("first Start in the dashboard" in line and "Runtime panel" in line for line in self.logs)
        )
