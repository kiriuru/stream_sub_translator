...
_STYLE_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "accessibility_high_contrast": _preset_style(
        ...
        description="Large type, thick outline, and a strong caption pill for low-vision viewers (inspired by accessibility-focused stream presets).",
        base={
    ...
    "dark_cinema": _preset_style(
        preset="dark_cinema",
        label="Dark Cinema",
        description="Soft theatrical look: bright text on a deep translucent panel, tuned for dark gameplay or night streams.",
        base={
            "font_family": '"Segoe UI Semibold", "Segoe UI", sans-serif',
            "font_size_px": 32,
            "font_weight": 750,
    ...
    "meeting_soft": _preset_style(
        preset="meeting_soft",
        label="Meeting Soft",
        description="Smaller, calmer captioning for presentations or desk streams with less visual weight than bold game styles.",
        base={
