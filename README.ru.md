...
- Web Speech всегда открывается в отдельном окне **Google Chrome** с изолированным `user-data-dir`, `HIGH_PRIORITY_CLASS`, opt-out из EcoQoS на Windows 10/11, Screen Wake Lock, терминальной деградацией `recognition_network_unreachable` и новым health-сигналом `voice_below_recognition_threshold`.
